...
const Services=()=> {
  ...
  return (
    ...
    <div className='services-mini-onee'>
        ...
        <div className='rightSide-services-mini-one'>
        <h3>Target your goals with an English online course designed around your needs.</h3>
         
            <ul className='the-list-in-services'>
              <li><span> &#10004;</span>  Choose your lesson themes.</li>   
                 <li><span> &#10004;</span> Choose the language that you like to learn.(English -French -Spanish. . .)</li>
                <li><span> &#10004;</span>  Target your goals.</li></ul><button className='meet-team-button' onClick={handleContactClick}>Contact Us </button> </div>
